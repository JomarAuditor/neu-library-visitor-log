    ...
    <div className="card-p h-full animate-fade-up delay-3">
      <div className="flex items-center gap-2.5 mb-5">
        ...
        <div>
          ...
          <p className="text-[11px] text-slate-400">Top 10 courses</p>
        </div>
      </div>
      {isLoading ? (
        ...
        <ResponsiveContainer width="100%" height={270}>
          <BarChart data={data} margin={{ top: 0, right: 10, left: -14, bottom: 12 }} barSize={20}>
            <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" vertical={false} />
            <XAxis dataKey="course"
              tick={{ fontSize: 11, fontFamily: 'Poppins', fill: '#94a3b8', fontWeight: 500 }}
              tickLine={false} axisLine={false} interval={0} angle={-35} textAnchor="end" height={52} />
            <YAxis tick={{ fontSize: 11, fontFamily: 'Poppins', fill: '#94a3b8' }}
