// CRITICAL FIX: Never show full-page spinner.
// The form always renders immediately.
// Spinner only appears on the submit button.
...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    if (profile && ['admin','staff'].includes(profile.role)) {
      ...
      setError(`No admin access for ${user.email}. Contact your administrator.`);
      signOut();
    }
  ...
  // ── NEVER "if (loading) return spinner" here — that causes infinite freeze ──
        ...
        <div className="bg-white rounded-3xl shadow-card-lg overflow-hidden">
          ...
          <div className="bg-neu-blue px-8 pt-8 pb-10">
            <div className="flex items-center gap-4 mb-6">
              <img src="/NEU%20Library%20logo.png" alt="NEU" className="h-14 w-14 object-contain"
              ...
              <div>
                ...
                <p className="text-white/60 text-xs">Library Management System</p>
              </div>
            </div>
