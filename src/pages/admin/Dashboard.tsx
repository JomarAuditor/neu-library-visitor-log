...
export default function Dashboard() {
  ...
  const handleExport = async () => {
    setExporting(true);
    try {
      const rows = await fetchAllLogsCSV(
        filter,
  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4 mb-6">
        ...
        {/* Live "Currently Inside" card */}
        <div className="sm:col-span-2 xl:col-span-1 animate-fade-up delay-4">
